...
![img](http://pr2lrdpbv.bkt.clouddn.com/Lusifer201805292246009.png)

点击 Monitor Stream，进入下一个界面，访问 http://localhost:8765/hi?message=HelloFeign此时会出现监控界面：

![img](http://pr2lrdpbv.bkt.clouddn.com/Lusifer201805292246010.png)
