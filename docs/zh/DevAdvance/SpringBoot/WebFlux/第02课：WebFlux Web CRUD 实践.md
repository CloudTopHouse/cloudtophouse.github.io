...
城市包含了城市编号、省份编号、城市名称和描述。具体开发中，会使用 Lombok 工具来消除冗长的 Java 代码，尤其是 POJO 的 getter / setter 方法，[具体查看 Lombok 官网地址](https://gitbook.cn/gitchat/column/5acda6f6d7966c5ae1086f2b/topic/projectlombok.org)。
...
Mono 是响应流 Publisher 具有基础 rx 操作符，可以成功发布一个元素或者一个错误，如图所示：

![file](http://springforall.ufile.ucloud.com.cn/static/img/9e9fc4aec1e96acb7cdc942aad0967e21523363)
...
![file](http://springforall.ufile.ucloud.com.cn/static/img/37dd113ad50858e41d17143911696e401523363)
...
![file](http://springforall.ufile.ucloud.com.cn/static/img/7ac13ad0583cc4e4ac49f6b9281706551523362)

获取城市信息列表 GET http://127.0.0.1:8080/city

![file](http://springforall.ufile.ucloud.com.cn/static/img/0fad82f29463fc7fe35900030500a0491523362)

其他接口就不演示了。

### 总结

这里，探讨了 Spring WebFlux 的一些功能，构建没有底层数据库的基本 CRUD 工程。为了更好的展示如何创建 Flux 流，以及如何对其进行操作，下篇内容会讲到如何操作数据存储。